...
--
-- Servidor: localhost
-- Tiempo de generación: 07-03-2024 a las 10:00:37
...
CREATE TABLE `productos_stocks` (
  ...
  `id_tienda` smallint UNSIGNED DEFAULT NULL,
  `id_producto` int UNSIGNED NOT NULL,
...
CREATE TABLE `promociones` (
  ...
  `dias_semana` varchar(21) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '[0,0,0,0,0,0,0]' COMMENT '0=No 1=Si... Lunes=Día_1 Domingo=Día_7'
...
(1CHARSET0, NULL, 'Oscar Rodríguez', 2, '1994-10-31', NULL, 10, 6),
...
ALTER TABLE `productos_categorias`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id_categoria_2` (`id_categoria`,`id_producto`),
...
--
ALTER TABLE `categorias`
  MODIFY `id` smallint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=204;
...
--
ALTER TABLE `productos_categorias`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94020;

--
-- AUTO_INCREMENT de la tabla `productos_stocks`
--
ALTER TABLE `productos_stocks`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114930;
...
--
ALTER TABLE `productos_categorias`
  ADD CONSTRAINT `productos_categorias_ibfk_2` FOREIGN KEY (`id_categoria`) REFERENCES `categorias` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `productos_categorias_ibfk_3` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `productos_stocks`
--
ALTER TABLE `productos_stocks`
  ADD CONSTRAINT `productos_stocks_ibfk_2` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `productos_stocks_ibfk_5` FOREIGN KEY (`id_tienda`) REFERENCES `tiendas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
